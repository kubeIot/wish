...
export const ROUTES: RouteInfo[] = [
  ...
  { path: 'application-add', title: 'New Application', menuType: MenuType.BRAND, icon:'pe-7s-plus' },
  { path: 'image-add', title: 'New Image', menuType: MenuType.BRAND, icon:'pe-7s-plus' },
  { path: 'capability-add', title: 'New Capability', menuType: MenuType.BRAND, icon:'pe-7s-plus' },
